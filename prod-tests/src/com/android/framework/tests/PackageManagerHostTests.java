...
public class PackageManagerHostTests extends DeviceTestCase {
    ...
    private static final String MAC_KEY = "626c6168"; // 'blah' the mac key in hex
    ...
    /**
     * Test that ensures we are able to install an encrypted apk, and that the resulting files are
